...
export const App = () => {
  ...
  const onAiProviderSettingsChanged = (
    ...
    if (settings.aiProvider === "Ollama") {
      updatedProviderSettings.Ollama = aiProviderSettings as OllamaSettingsType;
    } else if (settings.aiProvider === "OpenAI") {
      updatedProviderSettings.OpenAI = aiProviderSettings as ApiSettingsType;
    } else if (settings.aiProvider === "Anthropic") {
      updatedProviderSettings.Anthropic = aiProviderSettings as ApiSettingsType;
      ...
      updatedProviderSettings.xAI = aiProviderSettings as xAISettingsType;
    } else if (settings.aiProvider === "Google") {
      updatedProviderSettings.Google = aiProviderSettings as ApiSettingsType;
    ...
    <div className="flex flex-col p-6 max-w-7xl mx-auto">
          ...
          <div className="mt-4 p-4 rounded-lg border-l-4 border-green-300 bg-green-600 transition-colors duration-300">
            <div className="flex items-start gap-2">
              ...
              <svg
                ...
                className="h-5 w-5 border-green-600 mt-0.5 flex-shrink-0"
                viewBox="0 0 20 20"
                fill="currentColor"
              >
                <path
              ...
              <div>
                ...
                <p className="text-gray-100 text-sm">
                  You can create custom rules similar to other editors, create
                  ".cypherrules" in your project root to customize AI behavior.{" "}
                  <a
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <section className={cardClass}>
          ...
          />
          <MCPConfiguration mcpTools={mcpTools || []} />
        </section>
